...
variable "openshift_version" {
  type        = string
  default     = "4.20.6"
  description = "Desired version of OpenShift for the cluster, for example '4.20.6'. If version is greater than the currently running version, an upgrade will be scheduled."
}
